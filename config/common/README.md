...
| `push.feishu_sign_us` | 推荐 | 美股频道机器人签名校验密钥 | 添加机器人时勾选"签名校验"，复制密钥 |
| `push.feishu_hook_cn` | ⭐ 必填 | A 股新闻 / quote_watcher 推送的飞书机器人 webhook key | 同上，推荐另开一个群分流告警 |
| `push.feishu_sign_cn` | 推荐 | A 股频道机器人签名校验密钥 | 同上 |
...
```yaml
push:
  feishu_hook_us: REPLACE_ME   # 美股飞书群机器人
  feishu_hook_cn: REPLACE_ME   # A股飞书群机器人（也用于 quote_watcher 告警）
llm:
